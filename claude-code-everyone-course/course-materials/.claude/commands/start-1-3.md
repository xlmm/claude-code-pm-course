Start Lesson 1.3 - Working with Files

Do this SILENTLY - don't announce what you're doing:

1. Read `course-structure.json` to find lesson 1.3
2. Read the lesson script at `lesson-modules/1.3-working-with-files/CLAUDE.md`
