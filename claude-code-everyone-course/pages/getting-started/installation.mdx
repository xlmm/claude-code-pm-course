---
title: '0.1: Claude Code Installation'
description: 'Install Claude Code on Mac, Windows, or Linux. Prerequisites, installation commands, and troubleshooting.'
keywords: 'claude code install, claude code setup, install claude code mac, install claude code windows'
---
...
- 4 GB+ RAM
- Internet connection
- **No coding tools required!** (Node.js NOT needed)
...
After running, reload your shell or open a new terminal window.
