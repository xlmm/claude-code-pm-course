---
title: 'Install Claude Code in 15 Minutes (Mac, Windows, Linux)'
description: 'Copy-paste commands to install Claude Code on Mac, Windows, or Linux, written for non-coders: prerequisites, the exact steps, and how to know it worked.'
keywords: 'install claude code, claude code install, claude code download, how to install claude code, claude code install mac, claude code install windows, claude code install linux, claude code setup'
---
