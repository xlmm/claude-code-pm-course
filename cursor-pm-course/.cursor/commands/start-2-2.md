---
description: "Module 2.2: Analyze Data - Learn conversational data analysis with Cursor"
---

**Do this SILENTLY:**

1. Read `lesson-modules/2.2-analyze-data/SCRIPT.md` - this is your teaching script
