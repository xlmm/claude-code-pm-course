---
description: "Module 3.1.4: Building Your Style Database - Build a reusable library of styles and learn to extract styles from any image"
---

**Do this SILENTLY:**

1. Read `lesson-modules/3-nano-banana/3.1-intro-image-gen/3.1.4-style-database/SCRIPT.md` - this is your teaching script
