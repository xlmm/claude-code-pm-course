---
description: "Module 2.1: Write a PRD - Partner with AI to write better PRDs using templates, context, and multi-perspective review"
---

**Do this SILENTLY:**

1. Read `lesson-modules/2.1-write-prd/SCRIPT.md` - this is your teaching script
