...
name: start-1-3
description: |
  Module 1.3: Your First PM Tasks - Learn @ mentions and file operations. Use when the student types /start-1-3.
...
L="cursor-pms-1-3"; C="cursor-pms-1-4"; T="$(date -u +%FT%TZ)"
