...
name: start-2-1
description: |
  Module 2.1: Write a PRD - Partner with AI to write better PRDs using templates, context, and multi-perspective review. Use when the student types /start-2-1.
...
```bash
cp -rn .cursor/skills/start-2-1/assets/* . 2>/dev/null || true
```
...
- The key insight: AI isn't here to ghostwrite your PRD - it's here to help you think more clearly and move faster
- You'll drive every decision, I'll help you explore options and refine your thinking
...
- Here's what each file does:
	- prd-templates/: Two professional templates you can choose from (Carl's detailed version, Lenny's 7-question version)
	- taskflow-company-context.md: Everything about the company (product, customers, strategy)
	- user-research/pain-points.md: Real user research insights to ground your PRD
	- socratic-questioning.md: Framework for sharpening your feature thinking
	- reviewers/: Three different personas who'll review your PRD (engineer, executive, user researcher)
- STOP: Take a minute to look at the folder structure - do you see all these files?
- USER: Confirms
...
- ACTION: Read both prd-templates/Carls-PRD-Template.md and prd-templates/Lennys-PRD-Template.md
- Here are your options:
	- Carl's PRD Template: Comprehensive structure with Problem Alignment, Solution Alignment, and Development Planning - great for complex features needing stakeholder buy-in
	- Lenny's PRD Template: Minimal 7 questions (What, Why, Who, Success, etc.) - perfect for moving fast on smaller features
	- Your Own Template: For real PM work, you'd use whatever template your company prefers - these are just examples
- STOP: Which would you like to use for today's exercise? Say: "Carl's template", "Lenny's template", or "I'll use my own"
...
- Perfect! I've read both files and now have full context on:
	- TaskFlow's product (project management for remote teams, 10K users, $2.5M ARR)
	- Your target customers (SMBs with 5-20 person teams)
	- Key pain points from user research (complexity overwhelm, need for quick task capture)
- This context will make the PRD much stronger
...
- I'm going to use the Socratic questioning framework from socratic-questioning.md
- I'll ask you 3 strategic questions about your AI voice chat feature
...
- Here's a pro tip: AI is non-deterministic - the same inputs can produce different outputs
...
- ACTION: Create ai-chat-todo-prd-v1.md
	...
	- Incorporate company context, user research, and Socratic question answers
- ACTION: Create ai-chat-todo-prd-v2.md
	- Same inputs as v1 (template + context + research + answers)
	- AI will naturally produce variations in language and emphasis
- ACTION: Create ai-chat-todo-prd-v3.md
	- Same inputs as v1 and v2
	- Another variation to compare
- Done! I've created 3 draft PRDs using identical inputs
- Each one might emphasize different aspects, use different language, or structure arguments differently
- That's the nature of AI - non-deterministic outputs from the same inputs
- STOP: Review all 3 versions - which one resonates most? Say "v1", "v2", "v3", or "I want to combine elements from multiple versions"
- USER: Chooses version or combines
...
- Before anyone sees your PRD, let's get feedback from three different perspectives
- I have three reviewer personas in the reviewers/ folder: engineer (technical feasibility), executive (business value), user researcher (UX/needs)
...
- ACTION: Create ai-chat-todo-prd-review.md consolidating feedback from all three perspectives
...
- Done! I've updated your PRD with all the feedback responses
- You should see the changes highlighted in the file - this is how you'd actually iterate on a PRD in real work
- It now includes the phasing strategy, monetization approach, and UX onboarding plan you decided on
- STOP: Review the updated PRD file - do you see all the changes incorporated?
- USER: Confirms
...
- Excellent work! Let's recap what you just accomplished:
	...
	- ✅ Sharpened your feature idea through Socratic questioning
	- ✅ Generated 3 draft PRDs to compare
	- ✅ Got multi-perspective feedback (engineering, executive, UX)
	- ✅ Made strategic decisions on how to address feedback
	- ✅ Created a production-ready PRD incorporating all insights
- Here's the key insight: YOU drove this entire process
- I didn't ghostwrite a PRD for you
- STOP: Do you see how you made all the strategic decisions while I helped you think through options?
...
- This is what AI partnership looks like for PMs:
	...
	- AI helps you explore options (multiple drafts)
	- AI helps you stress-test ideas (multi-perspective review)
	- But YOU make all the decisions
- Now here's the best part: This workflow is YOURS to customize
- You can modify any step, add new steps, or remove steps that don't work for you
	- Want to add a fourth reviewer perspective? Create a designer.md file in the reviewers folder
	- Don't like Socratic questions? Skip that phase or replace it with a different framework
	- Want to use examples? Add a prd-examples/ folder with great PRDs from PMs at your company and @ mention them
	- Prefer different templates? Swap them out
- This is just ONE way to approach PRD writing - you'll build YOUR workflow over time
- The templates, context files, reviewer personas, and frameworks are all living documents you refine as you learn what works
- Congratulations - you now know how to partner with AI to write better PRDs faster!
- Next up: Module 2.2 is all about data analysis
- You'll learn how to analyze funnels, build ROI models, and run experiment analysis - the complete data-driven PM workflow
...
L="cursor-pms-2-1"; C="cursor-pms-2-2"; T="$(date -u +%FT%TZ)"
