...
- ✅ `.cursor/commands/start-2-1.md` - Slash command to launch module
...
**What happens:**
1. Claude reads `SCRIPT.md` and `.cursor/SCRIPT_INSTRUCTIONS.md`
...
To test:
1. Open the Cursor course project in Cursor
2. Type `/start-2-1` in the composer
