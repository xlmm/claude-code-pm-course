...
**Official:**
- [Cursor Documentation](https://cursor.com/docs) - Official feature docs
- [Cursor Chat Guide](https://cursor.com/docs/chat) - File references and @ mentions

**Community:**
- [Cursor Forum](https://forum.cursor.com) - Template strategies and examples
