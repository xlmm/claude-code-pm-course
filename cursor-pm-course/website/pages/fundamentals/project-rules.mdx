...
description: "Set up persistent context with .cursor/rules to teach Cursor about your product, terminology, personas, and output preferences"
keywords: 'project rules, .cursorrules, project context, AI settings, persistent memory, terminology'
---
...
**Official:**
- [Cursor Documentation](https://cursor.com/docs) - Official docs and features
- [Cursor Forum - Rules Discussion](https://forum.cursor.com) - Community examples and tips

**Community:**
- [Cursor Discord](https://discord.gg/cursor) - Get help from other users
