...
Cursor needs to index your files for context-aware AI features:

1. Click **Settings** (gear icon in bottom-left)
2. Go to **Features** tab
3. Find **"Codebase Indexing"**
4. Toggle it **ON** (blue)
5. Click "Index Now" if prompted

**What this does:** Allows Cursor to understand your entire project context when answering questions.
...
**Official:**
- [Cursor Download](https://cursor.com) - Get the latest version
