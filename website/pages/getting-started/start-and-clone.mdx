...
The same prompt works in the Claude Code CLI. (Haven't installed the CLI? See the [Claude Code CLI guide](/getting-started/claude-code-cli).) Open your terminal, make a folder for the course, and start Claude Code there:
