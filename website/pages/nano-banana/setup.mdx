...
**Starting fresh?** This course uses the Claude Desktop app. Open Claude, start a new project, and paste this prompt:
...
The same prompt works in the terminal. Start Claude Code in a folder for the course:
