...
If you don't have the course files yet, go back to the [Module Overview](/vibe-coding#get-the-course-materials) for setup instructions. If you installed the course for earlier modules, you already have Module 4. If Claude can't find `/start-4-1`, ask it to update the course with the FSPM CLI.
