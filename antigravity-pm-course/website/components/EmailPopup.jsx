  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://fullstackpm.com/api/subscribe', {
        ...
        body: JSON.stringify({
          email,
          source: 'antigravityforpms-popup',
          utm_source: 'antigravityforpms',
          utm_medium: 'popup',
    ...
    <>
      ...
      <div className="popup-container">
        ...
        <div className="popup-context-bar">
          Antigravity for PMs is part of <a href="https://fullstackpm.com" target="_blank" rel="noopener noreferrer">The Full Stack PM</a>
        </div>
