---
description: "Module 1.3: Your First PM Tasks - Real PM workflows with file editing and synthesis"
---
...
2. Read `.agent/rules/SCRIPT_INSTRUCTIONS.md` for critical teaching rules
