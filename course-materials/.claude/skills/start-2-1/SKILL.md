...
```bash
cp -rn ".claude/skills/start-2-1/assets/." .
```
...
**📄 [ai-chat-todo-prd-v1.md](ai-chat-todo-prd-v1.md) - Chat-First Approach**
[2-3 sentence summary of this version's strategic angle]

**📄 [ai-chat-todo-prd-v2.md](ai-chat-todo-prd-v2.md) - List-First Approach**
[2-3 sentence summary of this version's strategic angle]

**📄 [ai-chat-todo-prd-v3.md](ai-chat-todo-prd-v3.md) - Balanced Approach**
[2-3 sentence summary of this version's strategic angle]
...
- If these agent files were just staged, `@`-mention each one once so Desktop hot-registers it
...
**IMPORTANT:** Resolve and pass the actual absolute path programmatically; never ask the student to type it.
...
I've consolidated everything into [ai-chat-todo-prd-review.md](ai-chat-todo-prd-review.md) with full details from each agent.
...
L="cc-pms-2-1"; C="cc-pms-2-2"; T="$(date -u +%FT%TZ)"
...
**Next lesson:** [`/start-2-2`](.claude/skills/start-2-2/SKILL.md)
