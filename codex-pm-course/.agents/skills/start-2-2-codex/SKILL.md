...
```bash
cp -rn .agents/skills/start-2-2-codex/assets/* . 2>/dev/null || true
```
...
When you're ready, type **`start-2-3-codex`** to begin Module 2.3: Product Strategy!
