...
```bash
cp -rn .agents/skills/start-1-4-codex/assets/* . 2>/dev/null || true
```
...
Ready to build your team? Type `start-1-5-codex` when ready, or take a break!
