...
```bash
cp -n .agents/skills/start-1-5-codex/assets/feature-spec-realtime-collab.md . 2>/dev/null || true
cp -n .agents/skills/start-1-5-codex/assets/lesson-index.md . 2>/dev/null || true
cp -n .agents/skills/start-1-5-codex/assets/teaching-rules.md . 2>/dev/null || true
```
...
**STOP: When ready for Module 1.6 say "start-1-6-codex"**
