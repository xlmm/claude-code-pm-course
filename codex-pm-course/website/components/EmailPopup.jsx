...
export default function EmailPopup() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      setIsVisible(true)
      trackEvent('popup_shown', { popup_type: 'email_signup', source: 'codexforpms' })
    }, 10000)
  ...
  const handleClose = () => {
    ...
    trackEvent('popup_closed', { popup_type: 'email_signup', source: 'codexforpms' })
  }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://fullstackpm.com/api/subscribe', {
        ...
        body: JSON.stringify({
          email,
          source: 'codexforpms-popup',
          utm_source: 'codexforpms',
          utm_medium: 'popup',
      ...
      if (response.ok && data.success) {
        setStatus('success')
        localStorage.setItem('fspm-popup-seen', 'true')
        trackEvent('popup_submitted', { popup_type: 'email_signup', source: 'codexforpms' })
        setTimeout(() => {
          setIsVisible(false)
        }, 2500)
      } else {
    ...
    <>
      ...
      <div className="popup-container">
        ...
        <div className="popup-context-bar">
          Codex for PMs is part of <a href="https://fullstackpm.com" target="_blank" rel="noopener noreferrer">The Full Stack PM</a>
        </div>
            ...
            <div className="popup-inner">
              ...
              <div className="popup-left">
                ...
                <p className="popup-description">
                  Get weekly insights on using AI tools like Codex, Claude Code, and Cursor to build prototypes, automations, and more.
                </p>
              </div>
