...
export default {
  logo: <span style={{ fontWeight: 600 }}>Codex for Product Managers</span>,
  project: {
    link: 'https://github.com/carlvellotti/codex-pm-course'
  },
  docsRepositoryBase: 'https://github.com/carlvellotti/codex-pm-course/blob/main/website',
  feedback: {
  ...
  useNextSeoProps() {
    return { titleTemplate: '%s – Codex for Product Managers' }
  },
  theme: 'dark',
  head: function Head() {
    ...
    const siteUrl = 'https://codexforpms.com'
    const isHome = asPath === '/'
    ...
    return (
      <>
        ...
        <meta property="og:site_name" content="Learn Codex IN Codex!" />
